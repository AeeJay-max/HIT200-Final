...
import image1 from '../assets/harare-hero-tab-ver-1.webp';
          ...
          <div className="space-y-8 animate-slide-in-left">
            <div className="space-y-4">
              ...
              <p className="text-xl text-muted-foreground max-w-lg">
                Join hands in keeping Harare clean and functional. Report uncollected garbage, broken streetlights, potholes, or burst water pipes — and help city authorities respond faster to what matters most.
              </p>
            </div>
            ...
            <div className="grid grid-cols-3 gap-6 pt-8 border-t">
              <div className="text-center">
                <div className="text-2xl font-bold text-sky-500">{/*2615 */}</div>
